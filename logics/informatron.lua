...
local function menu(player_index)
  return {
    cat = 1,
    dog = 1,
    bird = {
...
local function page_content(page_name, player_index, element)
  -- main page
  if page_name == "mymod" then
    element.add { type = "label", name = "text_1", caption = { "paratoxic-modpack.page_mymod_text_1" } }
  end

  if page_name == "cat" then
    element.add { type = "label", name = "text_1", caption = { "paratoxic-modpack.page_cat_text_1" } }
  end

  if page_name == "dog" then
    element.add { type = "label", name = "text_1", caption = { "paratoxic-modpack.page_dog_text_1" } }
  end

  if page_name == "bird" then
    element.add { type = "label", name = "text_1", caption = { "paratoxic-modpack.page_bird_text_1" } }
  end

  if page_name == "penguin" then
    element.add { type = "label", name = "text_1", caption = { "paratoxic-modpack.page_penguin_text_1" } }
...
remote.add_interface("paratoxic-modpack", {
